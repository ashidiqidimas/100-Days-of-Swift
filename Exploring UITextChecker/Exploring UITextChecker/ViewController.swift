...
//  Exploring UITextChecker
//
//  Created by Dimas on 18/08/21.
//
...
class ViewController: UIViewController {
	...
	lazy var button: UIButton = {
		...
		b.setTitle("To check", for: UIControl.State.normal)
		b.setTitleColor(UIColor.white, for: UIControl.State.normal)
		b.setTitleColor(UIColor.black, for: UIControl.State.highlighted)
